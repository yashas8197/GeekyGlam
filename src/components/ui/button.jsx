  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-slate-300",
  {
    variants: {
      variant: {
        ...
        outline:
          "border rounded-none border-slate-200 bg-white shadow-sm hover:bg-slate-400 hover:text-white dark:border-slate-800 dark:bg-slate-950 dark:hover:bg-slate-800 dark:hover:text-slate-50",
        secondary:
        ...
        checkoutButton:
          "border border-black py-2 hover:text-white hover:bg-gray-600 rounded-none relative inline-flex items-center justify-start overflow-hidden transition-all group",
      },
      size: {
